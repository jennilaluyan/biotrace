    ...
    <tr>
        <td width="30%" style="vertical-align: top;">
            <table class="qc-table" style="font-size: 8.5px; margin-top: 0;">
                <tr style="background-color: #eee;"><th colspan="3">Quality Control</th></tr>
                <tr><td width="34%"></td><td width="33%">Pos</td><td width="33%">Neg</td></tr>
        ...
        <td width="70%" style="vertical-align: top; padding-left: 10px;">
            <div class="interpretation-box" style="margin-top: 0;">
                ...
                <div style="font-size: 8.5px; margin-top: 4px;">
                    ...
                    • <b>Hasil Negatif</b>: Material genetik SARS-CoV-2 tidak ditemukan atau di bawah limit deteksi alat.
                </div>
            </div>
        </td>
    </tr>
...
<table width="100%" style="margin-top: 20px;">
    <tr>
        ...
        <td width="60%" align="center"> {{-- Kolom TTD diperlebar --}}
