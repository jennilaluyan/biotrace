...
@section('content')
        ...
        <tr>
            <td width="55%">
                <table width="100%">
                    <tr>
                        <td width="45%">
                            Nama Institusi / Nama Pelanggan Permintaan Pengujian<br>
                            <span class="small-text">Institution Name / Customer's Name</span>
                        </td>: {{ $clientName }}</td>
                    </tr>
                    <tr>
                        <td>No. Handphone</td>
    ...
    <div style="width: 250px; margin-top: 15px;">
        <table class="qc-table" style="font-size: 9px;">
            ...
            <tr>
                <td width="34%"></td>
                <td width="33%">QC Positive</td>
                <td width="33%">QC Negative</td>
            </tr>
            <tr>
                <td>ORF1b</td>
                <td>+</td>
    ...
    <div class="interpretation-box">
        ...
        <ul style="margin: 5px 0; padding-left: 15px; list-style-type: disc; font-size: 9px;">
            <li><b>Hasil Positif atau terdeteksi</b> menunjukkan bahwa pada sampel terdeteksi material genetik
                SARS-CoV-2.<br>
                <span class="small-text">Positive or Detected results indicate that the SARS-CoV-2 genetic material was
                    detected in the sample.</span>
            </li>
            <li><b>Hasil negatif atau tidak terdeteksi</b> menunjukkan bahwa material genetik SARS-CoV-2 yang dimaksud tidak
                ditemukan di dalam sampel atau kadar sampel belum dapat terdeteksi oleh alat.<br>
                <span class="small-text">Negative or Undetectable results indicate that the SARS-CoV-2 genetic material in
                    question was not detected in the sample or sample levels could be detected by the instrument.</span>
            </li>
        </ul>
    </div>
