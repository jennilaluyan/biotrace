    ...
    <table class="info-table" cellpadding="0" cellspacing="0">
        <tr>
            <td width="55%">
                <table width="100%">
                    <tr>
                        <td width="45%">Nama Pelanggan Permintaan Pengujian / Instansi Pengirim<br><span
                                class="small-text">Customer's Name / sender</span></td>
                        <td>: {{ $clientName }}</td>
                    </tr>
                    <tr>
                        <td>No. Handphone</td>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 8.5px;">
                            : <b>Next Genome Sequencing (NGS)</b> <b>(WGS)</b><br>
